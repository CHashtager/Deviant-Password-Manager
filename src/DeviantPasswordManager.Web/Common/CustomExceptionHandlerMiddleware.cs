...
namespace DeviantPasswordManager.Web.Common;
    ...
    private Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        switch (exception)
        {
            case IdentityException identityException:
                ...
                result = JsonConvert.SerializeObject(identityException.Failures);
                break;
            ...
            case AuthenticationException authenticationException:
                ...
                result = JsonConvert.SerializeObject(authenticationException.Errors);
                break;
